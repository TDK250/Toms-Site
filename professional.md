    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .skills-grid, .accomplishments-grid {
...
<body>
    <div class="container">
        ...
        <h2 class="section-header">Professional Timeline</h2>
        <div class="timeline">
            <div class="timeline-item">
                <div class="timeline-date">Jan 2025 - Present</div>
                <div class="timeline-content">
                    <h3>Quality Assurance Specialist <span class="work-tag remote-tag">Remote</span><span class="work-tag pilot-tag">Pilot Position</span></h3>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <h3>Administrative Assistant <span class="work-tag hybrid-tag">Hybrid</span></h3>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <h3>Business Co-op and Career Social Media Coordinator <span class="work-tag part-time-tag">Part-Time</span></h3>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <h3>Business Co-op and Career Social Media and Events Co-op Student <span class="work-tag coop-tag">Co-op</span></h3>
                    <p class="company">University of Victoria</p>
                    <ul>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <h3>Photographer & Videographer <span class="work-tag freelance-tag">Contract</span></h3>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <h3>Special Projects Coordinator <span class="work-tag coop-tag">Co-op</span></h3>
                    <p class="company">Victoria Brain Injury Society</p>
        ...
        <h2 class="section-header">Leadership & Volunteer Experience</h2>
        ...
        <h2 class="section-header">Accomplishments & Recognition</h2>
